...
#'
#' Donegan C, Hughes AE, Lee SC (Forthcoming). Colorectal Cancer Incidence, Inequality, and Prevention Priorities in Urban Texas: Surveillance Study with the surveil software package. JMIR Public Health & Surveillance. <doi:10.2196/34589>
#' 
