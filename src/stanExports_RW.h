...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(51, 49, "end", "model_RW");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "population", "int", context__.to_vec(K,TT));
            population = std::vector<std::vector<int> >(K, std::vector<int>(TT, int(0)));
            vals_i__ = context__.vals_i("population");
            pos__ = 0;
            size_t population_k_0_max__ = K;
            size_t population_k_1_max__ = TT;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("mu", "(is_poisson ? TT : 0 )", (is_poisson ? TT : 0 ));
            validate_non_negative_index("mu", "(is_poisson ? K : 0 )", (is_poisson ? K : 0 ));
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > mu((is_poisson ? K : 0 ), Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>((is_poisson ? TT : 0 )));
            ...
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 22;
            size_t mu_k_0_max__ = (is_poisson ? K : 0 );
            size_t mu_j_1_max__ = (is_poisson ? TT : 0 );
            ...
            for (int j = 1; j <= K; ++j) {
                ...
                if (as_bool(is_binomial)) {
                    current_statement_begin__ = 30;
                    lp_accum__.add(binomial_logit_log(get_base1(y, j, "y", 1), get_base1(population, j, "population", 1), get_base1(eta, j, "eta", 1)));
                }
                current_statement_begin__ = 31;
                lp_accum__.add(normal_log(get_base1(get_base1(eta, j, "eta", 1), 1, "eta", 2), get_base1(prior_eta_1_location, j, "prior_eta_1_location", 1), get_base1(prior_eta_1_scale, j, "prior_eta_1_scale", 1)));
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            validate_non_negative_index("mu", "(is_poisson ? TT : 0 )", (is_poisson ? TT : 0 ));
            validate_non_negative_index("mu", "(is_poisson ? K : 0 )", (is_poisson ? K : 0 ));
            std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > mu((is_poisson ? K : 0 ), Eigen::Matrix<double, Eigen::Dynamic, 1>((is_poisson ? TT : 0 )));
            stan::math::initialize(mu, DUMMY_VAR__);
            stan::math::fill(mu, DUMMY_VAR__);
            ...
            for (int j = 1; j <= K; ++j) {
                ...
                if (as_bool(is_binomial)) {
                    ...
                    stan::model::assign(rate, 
                                stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list()), 
                                inv_logit(get_base1(eta, j, "eta", 1)), 
                                "assigning variable rate");
                    ...
                    for (int t = 1; t <= TT; ++t) {
                        ...
                        stan::model::assign(log_lik, 
                                    stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list())), 
                                    binomial_logit_log(get_base1(get_base1(y, j, "y", 1), t, "y", 2), get_base1(get_base1(population, j, "population", 1), t, "population", 2), get_base1(get_base1(eta, j, "eta", 1), t, "eta", 2)), 
                                    "assigning variable log_lik");
                    }
                }
            }
